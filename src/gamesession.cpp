...
/*!
 * \brief Конструктор класса игрового сеанса
 * \param parent Родительский объект QOnject
 */
...
/*!
 * \brief Инициализация игрового сеанса
 * \param numCards Количество карт для выдачи
 */
...
/*!
 * \brief GameSession::generateCards Генерация гарт
 * \param num Количество карт
 * \param ctype Тип карт
 * \param connections Флаг коренной карты
...
/*!
 * \brief Обращение к объекту игрового сеанса
 * \param reset Флаг сброса параметров
 * \return Объект игрового сеанса
 */
...
/*!
 * \brief Получение отображаемой информации и картах (включая изображения)
 * \return Список элементов информации о карте
 */
...
/*!
 * \brief Получение передатчика информационных соообщений
 * \return Объект передатчика
 */
 ...
 * \param uid ID карты
 * \return Текст информации о карте
 */
...
/*!
 * \brief Сохранение состояния игры
 * \return Результат процесса сохранения
 */
...
/*!
 * \brief Загрузка состояния игры
 * \return Результат процесса загрузки
 */
...
/*!
 * \brief Получение текущего игрока
...
/*!
 * \brief Получение следующего игрока
 * \return Объект следующего игрока
 */
...
/*!
 * \brief Перенаправление текстового сообщения
 * \param Сообщение
 */
...
/*!
 * \brief Запрос на получение информации о карте
 * \param dest Тип поля для карт
 * \param id ID карты
 */
...
/*!
 * \brief Перенаправление запроса на удаление элемента карты
...
/*!
 * \brief Перенаправление запроса на добавление элемента карты
 * \param item Элемент информации о карте
...
/*!
 * \brief Перенаправление запроса на обновление элемента карты
 * \param item Элемент информации о карте
 */
...
/*!
 * \brief Перенаправление запроса на установку режима выделения
 * \param enable Включение режима
 * \param owned Выбор своих карт
 */
...
/*!
 * \brief Перенаправление запроса на отображение числа карт противника
 * \param count Количество карт противника
 */
...
/*!
 * \brief Перенаправление запроса о получении информации об эффектах
 * \param effs Коллекция элементов информации об эффектах
 */
...
/*!
 * \brief Перезапуск потока текущего игрока
 */
...
/*!
 * \brief Отправка игроку выборки карт
...
/*!
 * \brief Установка текущего элемента информации об ээффекте
